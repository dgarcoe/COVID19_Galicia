...
fig = go.Figure([go.Bar(y=["Pfizer","Moderna"], x=[df_vac["Dosis entregadas Pfizer"].tail(1).values[0],df_vac["Dosis entregadas AstraZeneca"].tail(1).values[0],df_vac["Dosis entregadas Moderna"].tail(1).values[0]], orientation='h')])
